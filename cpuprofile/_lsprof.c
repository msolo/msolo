...
#ifdef MS_WINDOWS
#error "No windows in this build."
...
{
	struct rusage ru;
	PY_LONG_LONG stime, utime;
	getrusage(RUSAGE_SELF, &ru);
	utime = ru.ru_utime.tv_sec;
	utime = utime * 1000000 + ru.ru_utime.tv_usec;
	stime = ru.ru_stime.tv_sec;
	stime = stime * 1000000 + ru.ru_stime.tv_usec;
	return utime + stime;
}
...
{
	PyObject *module, *d;
	module = Py_InitModule3("_cpuprof", moduleMethods, "Fast profiler");
	if (module == NULL)
		return;
